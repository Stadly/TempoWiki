...
require(['$api/models', '$views/utils/css', '$views/list#List', '$views/buttons#Button', '$views/throbber#Throbber'], function(models, css, List, Button, Throbber) {
	...
	models.session.user.load('username', 'identifier').done(function() {
		...
		,	function(config) {
				...
				DanceGenres = new DanceGenres(config['dance-genres'], css, Button);
